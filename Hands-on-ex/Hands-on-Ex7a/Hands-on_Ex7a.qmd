---
title: "Hands-on Exercise 7a - Choropleth Mapping in R"
...
# 7.2 Installing and Loading R packages
...
-   Master Plan 2014 Subzone Boundary (Web) (i.e. `MP14_SUBZONE_WEB_PL`) in ESRI shapefile format. It can be downloaded at [data.gov.sg](https://data.gov.sg/) This is geospatial data and consists of the geographical boundary of Singapore at the planning subzone level. The data is based on URA's Master Plan 2014.

-   Singapore Residents by Planning Area / Subzone, Age Group, Sex and Type of Dwelling, June 2011-2020 in csv format (i.e. `respopagesextod2011to2020.csv`). This is aspatial data and can be downloaded at [Department of Statistics, Singapore](https://www.singstat.gov.sg/) Although it does not contain any coordinates values, it’s PA and SZ fields can be used as unique identifiers to geocode to `MP14_SUBZONE_WEB_PL` shapefile.

## 7.3.1 Importing Geospatial Data into R
...
## 7.3.2 Importing Attribute Data into R
...
## 7.4.8 Plotting Practise

Below are a few additional plots for practise

# 7.5 References

Main reference: Kam, T.S. (2024). [Choropleth Mapping with R.](https://r4va.netlify.app/chap21)
