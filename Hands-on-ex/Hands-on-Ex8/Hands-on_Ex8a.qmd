...
![](images/clipboard-335572159.png)

### The Nodes Data

-   *GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

![](images/clipboard-991851558.png)
...
### Wrangling with Data Attributes
...
### The `dplyr` Verbs in `tidgraph`

-   *activate()* verb from **tidygraph** serves as a switch between tibbles for nodes and edges. All dplyr verbs applied to **tbl_graph** object are applied to the active tibble.

![](images/clipboard-3965863484.png)
...
![](images/clipboard-1083923365.png)

### ![](images/clipboard-1234468127.png)Fruchterman and Reingold Layout
...
### Working with `facet_edges()` Themes
