...
# 7.2 Loading R packages and Importing Data
...
We have now seen the importance to map rates rather than counts of things, for the simple reason that water points are not equally distributed in space.
...
## 7.4.2 Plotting map using rates, instead of counts
...
## 7.5.3 Plotting Practise

Below are some additional plots for practise

# 7.6 References

Main reference: Kam, T.S. (2024). [Analytical Mapping.](https://r4va.netlify.app/chap23#overview)
