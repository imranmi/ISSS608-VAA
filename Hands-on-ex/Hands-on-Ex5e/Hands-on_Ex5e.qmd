...
```{r}
aggregated_data_locality <- GTD_summarised %>%
  group_by(country_txt, region_txt, city) %>%
  summarise(
...
# Create the treemap
tm1 <- treemap(aggregated_data_locality,
        index=c("region_txt", "country_txt"),
        vSize="TotalEvents",
        vColor="TotalKills",
        type = "manual",
        algorithm = "pivotSize",
        sortID = "TotalKills",
        title="The Global Impact- Which country has suffered most casualties?",
        palette="Reds",
        border.col="white",
        border.lwds=0.5)
```
...
```{r}
d3tree(tm1,rootname = "Countries with most casualties" )
```
...
```{r}
# Create the treemap
tm2 <- treemap(aggregated_data_attack,
        index=c("country_txt", "attacktype1_txt"),
        vSize="TotalEvents",
        vColor="TotalKills",
        type = "manual",
        algorithm = "pivotSize",
        sortID = "TotalKills",
        title="The types of Attacks carried out in each country",
        palette="Reds",
        border.col="white",
        border.lwds=0.5)
```
...
```{r}
d3tree(tm2,rootname = "Attack types" )
```

```{r}
# Create the treemap
t3 <- treemap(aggregated_data_attack,
        ...
        algorithm = "pivotSize",
        sortID = "TotalKills",
        title="The Common Attack types in each Region",
        palette="Reds",
        border.col="white",
        border.lwds=0.5)
```
...
```{r}
d3tree(t3,rootname = "Attack Types" )
```

```{r}
# Create the treemap
tm4 <- treemap(aggregated_data_attack,
        index=c("country_txt", "weaptype1_txt"),
        vSize="TotalEvents",
        vColor="TotalKills",
        type = "manual",
        algorithm = "pivotSize",
        sortID = "TotalKills",
        title="The Common weapons used in each Country",
        palette="Reds",
        border.col="white",
        border.lwds=0.5)
```
...
```{r}
d3tree(tm4,rootname = "Common weapons used" )
```

```{r}
# Create the treemap
tm5 <- treemap(aggregated_data_attack,
        index=c("region_txt", "weaptype1_txt"),
        vSize="TotalEvents",
        vColor="TotalKills",
        type = "manual",
        algorithm = "pivotSize",
        sortID = "TotalKills",
        title="The Common weapons used in each Region",
        palette="Reds",
        border.col="white",
        border.lwds=0.5)
```
...
```{r}
d3tree(tm5,rootname = "Common Weapons used" )
```

```{r}
# Create the treemap
tm6 <- treemap(aggregated_data_attack,
        ...
        algorithm = "pivotSize",
        sortID = "TotalKills",
        title="Who are the Main Targets in each Region?",
        palette="Reds",
        border.col="white",
        border.lwds=0.5)
```
...
```{r}
d3tree(tm6,rootname = "Main Targets" )
```

# 5.8 References

Main reference: Kam, T.S. (2024). [Treemap Visualisation with R](https://r4va.netlify.app/chap16#overview)
