...
Labels, annotations and legends serve to inform, but also increases duplicity. Instead of worrying whether there is enough labels to explain and guide readers, it is better to focus on how easy the reader can obtain that information.

3.  **What is the information you want to communicate?**

It is important understand the purpose, intent and effect of the visualization. If we are confused about what we want to communicate, readers will feel the same way as well.
