...
The code below uses the `instvy package` to determine the composite Means and Standard Deviations of PV values across the population of students that took the assessment.
...
The author had created a series of box plots across the 3 subjects to represent the distribution of Student scores across the 3 subjects.
...
+=====================+=======================================================================================================================================================================================================+======================================================================================================================================================================================================================================================================================+
| **Clarity**         | 1.  Although the original plot enables me to visualize the differences in scores across subjects, I am unclear as to which score this is showing. ie is it PV1, average of PV values?                 | 1.  The code and subset used is not suitable to plot a **Distribution** of student scores across subjects. I will extract a new subset with all PV1 scores at the individual student level. This will be used to plot the distribution of student scores for the different subjects. |
|                     |                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                                      |
...
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| **Aesthetics**      | 1.  There is already a legend on the right which identifies subjects by colour, thus making the Y axis labels seem redundant.                                                                         | 1.  To remove the legend or Y-Axis labels, to minimize non-data ink.                                                                                                                                                                                                                 |
|                     |                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                                      |
|                     | 2.  The scale for the X-axis is from 0 to 1000, in increments of 50. Because of the "shortness" of the box plots/error bars, the graph appears too elongated.                                         | 2.  Shorten the X-axis, or extract new data points to populate the correct range of scores.                                                                                                                                                                                          |
|                     |                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                                      |
...
|                     |                                                                                                                                                                                                       |                                                                                                                                                                                                                                                                                      |
|                     | 4.  Since the subjects are clearly labelled in the Y axis, the label “Subject” can be removed, to minimize non-data ink.                                                                              | 4.  To remove the label "Subject".                                                                                                                                                                                                                                                   |
+---------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
The code and subset used by the author will not be able to plot a **Distribution** of student scores across subjects.

I will revert to the original large data set to extract and use PV1 scores which are available for all students to create new plots to visualize the distribution of scores.
:::
...
![](images/clipboard-1970715586.png)
...
| Assessment Criteria | Critique/Feedback                                                                                                                                                                                                 | Possible Improvements                                                                                                                                                                                                                                                                      |
+=====================+===================================================================================================================================================================================================================+============================================================================================================================================================================================================================================================================================+
| **Clarity**         | 1.  Although the original plot enables me to visualize the differences in scores across schools, I am unclear as to which score this is showing. ie Is it showing me the range of student scores by school ID?    | 1.  The original subset can still be used, but the code will need to be changed for the revised visualization. This new visualization will retain the original intent to show the different mean scores for each of the 164 schools in visualize the relative performance across subjects. |
|                     |                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                            |
...
|                     |                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                            |
|                     | 2.  Since there are 164 schools, the use of a vertically long format makes it difficult to read the school IDs on the Y-axis. ie too many schools to make identification off the Y-axis easy.                     | 2.  To minimize axis labels, we can drop axis labels for school id, and only identify and directly annotate the top & bottom 5 schools instead.                                                                                                                                            |
|                     |                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                            |
|                     | 3.  The distance between the X-axis, which shows the scores is too far apart from the box plots. I am unable to decipher what are the actual scores or score range for each box plot.                             | 3.  To remove the 2 other repetitive Y-axes to minimize non-data ink.                                                                                                                                                                                                                      |
|                     |                                                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                            |
...
I will use a new compact visualization to enable the reader to quickly identify the disparity in school performance.
:::
...
Using the exact same data set as the author, I will use the code below to re-make the original graph into Bubble plots for each subject. For this remake, I will employ color as a means to differentiate the mean scores.
...
Annotating all the 164 school IDs will add too much ink to the plot. Hence, we can consider having another interactive plot (below) for readers to examine the data points in more detail.
:::
...
The author had created a series of box plots across the 3 subjects to represent the subject scores by gender.
...
| Assessment Criteria | Critique/Feedback                                                                                                                                                                                                       | Possible Improvements                                                                                                                                                                              |
+=====================+=========================================================================================================================================================================================================================+====================================================================================================================================================================================================+
| **Clarity**         | 1.  Although the original plot enables me to visualize the differences in scores between the genders, I am unclear as to which score this is showing. Is it showing me the range of PV1 scores or average of PV values? | 1.  The code and subset used is not suitable to plot a range of scores for each gender across subjects.                                                                                            |
|                     |                                                                                                                                                                                                                         |                                                                                                                                                                                                    |
|                     | 2.  Graph is titled as “Subject Scores by Gender”, however the code indicates that mean scores +/- one standard deviation were generated instead.                                                                       | 2.  I will extract a new subset with all PV1 scores at the individual student level. This will be used to plot the distribution and range of scores for the different genders across all subjects. |
|                     |                                                                                                                                                                                                                         |                                                                                                                                                                                                    |
...
|                     |                                                                                                                                                                                                                         |                                                                                                                                                                                                    |
|                     | 2.  The scale for the X-axis is from 0 to 1000, in increments of 50. Because of the “shortness” of the box plots/error bars, the graph appears too elongated.                                                           | 2.  Shorten the X-axis, or extract new data points to correctly populate the range of scores.                                                                                                      |
|                     |                                                                                                                                                                                                                         |                                                                                                                                                                                                    |
|                     | 3.  Unable to decipher the actual scores even with the granularity in X-axis tick marks.                                                                                                                                | 3.  To annotate the mean scores onto the plot, so that we can remove the background grid lines and X-axis tick marks and reduce non-data ink.                                                      |
|                     |                                                                                                                                                                                                                         |                                                                                                                                                                                                    |
...
![](images/clipboard-774416978.png)

### 3.3.3 Remake

The original data subset and plot is unable to exhibit the full range and distribution of subject scores across genders, due to the lack of scores at an individual student level.
...
The author had created a series of box plots to represent the scores across the 4 categories of the ESCS score (High, Medium, Low, Very Low).
...
| Assessment Criteria | Critique/Feedback                                                                                                                                                                                                     | Possible Improvements                                                                                                                                                                                                                                |
+=====================+=======================================================================================================================================================================================================================+======================================================================================================================================================================================================================================================+
| **Clarity**         | 1.  Although the original plot enables me to visualize the differences in scores between Etegories, I am unclear as to which score this is showing. Is it showing me the range of PV1 scores or average of PV values? | 1.  The code and subset used is not suitable to plot a range or distribution of scores for each ESCS score category.                                                                                                                                 |
|                     |                                                                                                                                                                                                                       |                                                                                                                                                                                                                                                      |
...
The author had created a series of 2 box plots for each school ID across the 3 subjects to represent the subject scores for each gender for all schools (164 schools).
...
|                     |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                         |
|                     | 3.  The distance between the X-axis, which shows the scores is too far apart from the box plots. I am unable to decipher what are the actual scores or score range for each box plot.                                                                                           |                                                                                                                                                                                                                         |
|                     |                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                                                         |
|                     | 4.  The graph is patched side by side, resulting in the Y-axis being repeated 3 times. The order of the School IDs are all the same, hence this creates additional non-data ink, that makes the graph too “busy”.                                                               |                                                                                                                                                                                                                         |
+---------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
