...
we will set up the data set to be for 2021-2023, and in quarterly periods
...
#write.csv(df_complete, "data/df_complete.csv", row.names = FALSE)
```
...
# Filtering the Event and Quarter (Event type = Battles, in 2023Q4)
...
Figure above reveals that there is are several hot spot areas and these areas coincide with the High-high cluster identifies by using local Moran’s I method in the earlier sub-section.
