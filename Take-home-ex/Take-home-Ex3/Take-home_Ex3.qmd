...
\
For example, 2023 seem to have more "heavy" rainfall events relative to previous years, albeit with a lesser number of rain days.
:::
...
For example, among the 5 years, the heaviest rainfall event happened in 1983. However, the intensity of "heavy" rainfall events in 2023 seemed to be the weakest relative to previous years.
:::
...
\
For example, the highest recorded daily rainfall event was in December 1983 at 164.4 mm. This has not yet been eclipsed in subsequent years.\
\
...
To visualise this difference in the June-December periods, I will use the codes below to plot:
...
Hence, this may not as yet, lead credence to the claim that the intensity and frequency of heavy rain fall events is expected to increase as the world gets warmer.
:::
...
In the code below, [`stat_gradientinterval()`](https://mjskay.github.io/ggdist/reference/stat_gradientinterval.html) of **ggdist** is used to build a visual for displaying distribution of daily rainfall measurements for July and Decemeber by Year.
