...
# 3. Visualising Differences in Daily Rainfall 
...
::: callout-tip
## Observation 1 - Frequency and Intensity of Rainfall events
...
::: callout-tip
## Observation 2 - Contrast between Dry and Wet Months
...
This supports **Observation 3**, where we concluded that the contrast between Dry and Wet months is likely to be more pronounced.
:::

# 4. Visualising Uncertainty in Daily Rainfall

I will use the code below to plot Hypothetical Outcome Plots for July and December daily rainfall.
