...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem("Confirmatory Analysis",icon = icon("clipboard-check"),
             href = "https://group5vaa.shinyapps.io/Decoding-Chaos-Confirmatory"),
      ...
      column(4,
             box(title = "Map Panel",
                 ...
                 selectizeInput(inputId = "EventSelect_eo1",
                                ...
                                options = list(placeholder = 'Enter Event'),
                                multiple = TRUE),
                 ...
                 conditionalPanel(
                   ...
                   selectizeInput(inputId = "AdminSelect_eo1",
                                  ...
                                  multiple = TRUE,
                                  options = list(placeholder = 'Enter Region 1'))
                 ),
                 conditionalPanel(
                   ...
                   selectizeInput(inputId = "AdminSelect_eo2",
                                  ...
                                  multiple = TRUE,
                                  options = list(placeholder = 'Enter Region 2'))
                 ),
...
## commented out for confirmatory
# Confirm1 <- fluidRow(
#   column(3,
